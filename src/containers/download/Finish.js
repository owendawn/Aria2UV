            ...
            <div className="row">
                <div data-spy="scroll" data-target="#list-example" data-offset="0" className="scrollspy-example col-9">
                    <div className="accordion" id="accordionExample">
                        {this.props.Finishs.map((it)=>(<ToDownload item={it} key={it.gid} choose={this.chooseIt.bind(this)} open={it.gid===this.state.chooseId} info={this.props.ToDownloadOption.filter(o=>o.id.indexOf(it.gid)!==-1)}/>))}
                    </div>
                </div>
